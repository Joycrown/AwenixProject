...
function Footer() {
  ...
  return (
    <footer className="grid grid-cols-1 md:grid-cols-2 gap-9 lg:flex justify-center bg-default-100">
      <div className="flex flex-col py-14">
        ...
        <form className="relative py-3">
          <input className="bg-default-100 border-default-800 border-2 placeholder:text-default-300 p-2 outline-none text-default-800 rounded w-4/5" type="email" placeholder="Enter your email" value={email} onChange={handleChange} />
          <VscSend className="text-2xl text-default-800 absolute top-5 right-[4.8rem] cursor-pointer hover:text-default-800"/>
        </form>
      </div>
      ...
      <div className="flex flex-col py-14">
        ...
        <div className="flex p-2 gap-3 pt-3">
